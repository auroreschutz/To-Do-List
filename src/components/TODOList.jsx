        ...
        <>
          <button className="todo_items_left" onClick={completeTodo}>
            <svg
              ...
              height={34}
              stroke="#ffffff50"
              fill={item.is_completed ? "#fff" : "#ffffff50"}
            >
          ...
          <div className="todo_items_right">
            <button onClick={handleEdit}>
              ...
              <div className="wand"><IconContext.Provider value={{ size: "2em", className: "magicwandicon" }}><FaEdit /></IconContext.Provider></div>
            </button>
            <button onClick={handleDelete}>
              <span className="visually-hidden">Delete</span>
              <div className="wand"><IconContext.Provider value={{ size: "2em", className: "magicwandicon" }}><FaRegTrashAlt /></IconContext.Provider></div>
            </button>
          </div>
        </>
      )}
